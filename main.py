...
def stylize_post(news):
    prompt = f"""
Сделай короткий, интересный и неформальный Telegram-пост на русском языке по этой новости. Пост должен быть:
- Без лишней воды
- Понятен даже новичку
- С лёгким юмором или метафорой
- Эмодзи и форматирование — приветствуются
- Без подзаголовков вроде "Суть:", "Вывод:" и т.д.

Формат:
🚀 <b>Заголовок</b>
📅 Дата и источник
🧠 Интересный пересказ сути (2-4 строки)
🔍 Почему это важно
💬 Вопрос, шутка или мем в конце
🔗 Ссылка
