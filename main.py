import os
 ...
 def stylize_post(news):
     prompt = f"""
 Сделай короткий, интересный Telegram-пост на русском языке, по этому образцу:
 
 🚀 Google добавил ручку для управления размышлениями своей модели AI  
 📅 17 апреля 2025г., MIT Technology Review  
 🔹 Google DeepMind обновил свою модель AI Gemini и добавил ручку для управления тем, насколько система "размышляет" в ответе. Эта функция призвана экономить деньги для разработчиков, но признает проблему: модели размышления, новая страсть технологического мира, склонны к переанализу, сжигая деньги и энергию…  
 💡 Важно для понимания, как развивается мир искусственного интеллекта и какие новые проблемы возникают.  
 🤔 Как вы думаете, насколько важно уметь контролировать "размышления" AI модели?  
 🔗 Ссылка: https://www.technologyreview.com/2025/04/17/1115375/a-google-gemini-model-now-has-a-dial-to-adjust-how-much-it-reasons/
 
 ---
 
 Вот новость, которую нужно оформить в таком же стиле:
 ...
 🔸 Не используй подзаголовки вроде "Суть:" или "Вывод:" — просто эмодзи и текст предложений минимум на 3 и не больше 8.  
 🔸 Не используй подзаголовки вроде "Суть:" или "Вывод:" — просто эмодзи и текст предложений минимум на 6 и не больше 20.  
 🔸 Сделай так, чтобы было понятно даже новичку.  
 🔸 Используй форматирование Telegram: <b>жирный</b> и эмодзи.  
 🔸 Вопрос в конце — желательно, вовлекающий.
